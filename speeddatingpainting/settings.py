"""
Django settings for speeddatingpainting project.
...
SECRET_KEY = '-*6-q2()sm(as6e*g$#jos9gvr0oxlnz*!cv*qias#*7ja^^eh'
...
ROOT_URLCONF = 'speeddatingpainting.urls'
...
WSGI_APPLICATION = 'speeddatingpainting.wsgi.application'
